...
Updates:
1. This version includes the following additional files
	a. README.md - updated to describe additional files to the tidy version of this dataset
	b. run_analysis.r - script to produce the tidy data
	c. codebook.md - describes the data cleaning script to produce the tidy data
	c. tidydata.txt - the cleaned data
